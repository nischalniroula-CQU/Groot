...
//	}
	...
	public ResponseEntity<AddProductResponse> updateProduct(@PathVariable("id") Long productId, @RequestBody AddProductRequest request) {
	...
	public ResponseEntity<GetAllProductsResponse> getProductsByForeignId(@RequestBody GetProductsByForeignIdRequest request) {
