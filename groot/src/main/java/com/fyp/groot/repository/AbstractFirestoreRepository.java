...
import com.fyp.groot.commons.utility.DocumentId;
...
public abstract class AbstractFirestoreRepository<T> {
    ...
    public boolean save(T model){
		...
		/*
		 * try { log.info("{}-{} saved at{}", collectionName, documentId,
		 * resultApiFuture.get().getUpdateTime()); return true; } catch
		 * (InterruptedException | ExecutionException e) {
		 * log.error("Error saving {}={} {}", collectionName, documentId,
		 * e.getMessage()); }
		 */
    ...
    public List<T> retrieveAll(){
        ...
        try {
            ...
            System.out.printf("Exception occurred while retrieving all document for {}", collectionName);
        }
    ...
    public Optional<T> get(String documentId){
        ...
        try {
        	...
        	System.out.printf("Exception occurred retrieving: {} {}, {}", collectionName, documentId, e.getMessage());
        }
    ...
    private Object getKeyFromFields(Class<?> clazz, Object t) {
		...
		return Arrays.stream(clazz.getDeclaredFields())
						.filter(field -> field.isAnnotationPresent((Class<? extends Annotation>) DocumentId.class))
						.findFirst()
    ...
    @Nullable
      ...
      try {
        return field.get(t);
    	  ...
    	  System.out.printf("Error in getting documentId key", e);
      }
		  return null;
	  }
